...
<?php endif;?>
  ...
  <div id="quickstart">
    <ol>
      ...
      <li>
        <fieldset class="field-group-fieldset collapsible collapsed">
          <legend><img src="images/pencil.png" alt="pencil"> <span class="fieldset-legend">Add content to your homepage</span></legend>
          <div class="fieldset-wrapper">
      ...
      <li>
        <fieldset class="field-group-fieldset collapsible collapsed">
          <legend><img src="images/plus.png" alt="plus"> <span class="fieldset-legend">Create a new page on your site</span></legend>
          <div class="fieldset-wrapper">
  ...
  <div id="nextsteps">
    <ol>
      <li>
        <fieldset class="field-group-fieldset collapsible collapsed">
          <legend><img src="images/menu.png" alt="menu"> <span class="fieldset-legend">Edit your  navigation menus</span></legend>
          <div class="fieldset-wrapper">
      ...
      <li>
        <fieldset class="field-group-fieldset collapsible collapsed">
          <legend><img src="images/gear.png" alt="gear"> <span class="fieldset-legend">Add functionality and features</span></legend>
          <div class="fieldset-wrapper">
      ...
      <li>
        <fieldset class="field-group-fieldset collapsible collapsed">
          <legend><img src="images/brush.png" alt="brush"> <span class="fieldset-legend">Edit the look and feel of your site</span></legend>
          <div class="fieldset-wrapper">
